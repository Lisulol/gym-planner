        ...
        >
          ...
          >
            <div className="w-full p-10 flex items-center justify-center border-b-4 border-black">
              <p className="font-bold text-2xl text-white">Learn your splits</p>
            </div>
            {page === 0 && (
            ...
            {page === 1 && (
              <div className="w-full h-full flex flex-col items-center justify-center gap-10">
                <div className="w-full flex flex-col items-center justify-center h-4/5">
                  ...
                  <p className="text-white  font-bold text-center w-3/5">
                    Choose a split that fits your schedule and goals. Below are
                    ...
                    days.
                    <br />• Body-Part (Bro) Split: One or two muscle groups per
                    day.
              ...
              <div className="w-full h-full flex flex-col items-center justify-center gap-10">
                <div className="w-full flex flex-col items-center justify-center h-4/5">
                  ...
                  <p className="text-white  font-bold text-center w-full p-20 ">
                    FBW aka Full Body Workout is a training split where you work
                    out all major muscle groups in a single session. This split
                    is typically performed 3 times a week, allowing for adequate
                    recovery between sessions. FBW is ideal for beginners and
                    those with limited time to train, as it maximizes efficiency
                    and promotes overall muscle balance. This is the best split
                    for less then 3 days a week
                  </p>
                </div>
                <div className="flex items-center justify-between p-5 w-full">
                  <div className="flex">
              ...
              <div className="w-full h-full flex flex-col items-center justify-center gap-10">
                <div className="w-full flex flex-col items-center justify-center h-4/5">
                  ...
                  <p className="text-white  font-bold text-center w-full p-20 ">
                    ...
                    shoulders, triceps), pull exercises (back, biceps), and leg
                    exercises (quads, hamstrings, calves). This split is
                    typically performed 6 days a week, allowing for each muscle
                    group to be trained twice. PPL is suitable for intermediate
                    to advanced lifters looking to increase training volume and
                    frequency. This is the best split for 4-6 days a week
                  </p>
                </div>
                <div className="flex items-center justify-between p-5 w-full">
                  <div className="flex">
            ...
            {page === 4 && (
              <div className="w-full h-full flex flex-col items-center justify-center gap-10">
                <div className="w-full flex flex-col items-center justify-center h-4/5">
                  <div className="w-full flex items-center justify-center">
                    <p className="font-bold text-2xl text-white">Upper/Lower</p>
                  </div>
                  <p className="text-white  font-bold text-center w-full p-20 ">
                    Upper/Lower Split is a training split that alternates upper
                    and lower body days. Typically, you would train your upper
                    body on one day (focusing on chest, back, shoulders, arms)
                    and your lower body on the next (targeting quads,
                    hamstrings, glutes, calves). This split is usually performed
                    4 days a week, allowing for sufficient recovery between
                    sessions. The Upper/Lower Split is versatile and can be
                    adjusted for beginners to advanced lifters, making it a
                    popular choice for those looking to balance training volume
                    and frequency.
                  </p>
                </div>
                <div className="flex items-center justify-between p-5 w-full">
              ...
              <div className="w-full h-full flex flex-col items-center justify-center gap-10">
                <div className="w-full flex flex-col items-center justify-center h-4/5">
                  ...
                  <p className="text-white  font-bold text-center w-full p-20 ">
                    ...
                    Full-Body workouts with Push/Pull/Legs sessions or alternate
                    between Upper/Lower and Body-Part splits. The Hybrid Split
                    is ideal for those seeking variety in their workouts while
                    ensuring all muscle groups are adequately targeted
                    throughout the week.
                  </p>
                </div>
                <div className="flex items-center justify-between p-5 w-full">
